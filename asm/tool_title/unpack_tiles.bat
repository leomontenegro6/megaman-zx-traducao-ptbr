...
python tool_tilemap.py -m u -s "asm_title_000/000_tileset.bin" -d "asm_title_000/000_2_image.bin" -e 17 -c 8
python tool_tilemap.py -m u -s "asm_title_000/000_tileset.bin" -d "asm_title_000/000_3_image.bin" -e 18 -c 8
